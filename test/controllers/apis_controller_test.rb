...
class ApisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api" do
    assert_difference("Api.count") do
      post apis_url, params: { api: { description: @api.description, name: @api.name, url: @api.url } }
    end
  ...
  test "should update api" do
    patch api_url(@api), params: { api: { description: @api.description, name: @api.name, url: @api.url } }
